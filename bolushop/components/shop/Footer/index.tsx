        ...
        <footer className="bg-[#0f2044] text-white">
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-16 md:mb-24">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2">
                            <div className="w-8 h-8 bg-white rounded-md flex items-center justify-center">
                                <span className="text-[#0f2044] font-bold text-sm">B</span>
                            </div>
                            <div>
                                <div className="text-sm font-bold">BoluShop</div>
                                <div className="text-[10px] text-[#e8630a]">Regalos & Hogar</div>
                            </div>
                        </div>
                        <p className="text-xs leading-relaxed text-gray-300">
                            Curamos los mejores regalos originales y accesorios para el hogar de Argentina. Selección experta, envíos a todo el país.
                        </p>
                    ...
                    {/* Tienda Column */}
                    <div>
                        <h4 className="text-xs font-bold uppercase tracking-wider text-white mb-6">Tienda</h4>
                    ...
                    {/* Ayuda Column */}
                    <div>
                        <h4 className="text-xs font-bold uppercase tracking-wider text-white mb-6">Ayuda</h4>
                        <ul className="space-y-2 text-xs text-gray-300">
                    ...
                    {/* Contact Column */}
                    <div>
                        <h4 className="text-xs font-bold uppercase tracking-wider text-white mb-6">Contacto</h4>
                ...
                <div className="border-t border-white/10 pt-8 md:pt-12">
                    {/* Trust Section */}
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 mb-8 text-xs text-gray-300">
                        <div className="flex items-center gap-2">
                            <Truck size={14} />

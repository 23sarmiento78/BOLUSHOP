    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-lg">
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 text-center">
                ...
                <div className="bg-orange-50 border-2 border-orange-200 rounded-2xl p-6 mb-8 text-left animate-pulse">
                    <div className="flex items-center gap-3 mb-2">
                        <span className="bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded">PASO FINAL REQUERIDO</span>
                    </div>
                    <p className="text-orange-900 font-bold text-sm leading-relaxed">
                        Para que podamos despachar tu pedido, es <span className="underline italic">obligatorio</span> enviar el resumen de compra por WhatsApp ahora mismo.
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-4 mb-8">
                    ...
                    <div className="flex items-center gap-4 text-left p-4 bg-white rounded-xl border-2 border-primary/20">
                        ...
                        <div className="flex-grow">
                            <p className="font-bold text-gray-900 text-sm">Validar Pedido por WhatsApp</p>
                            <p className="text-xs text-primary font-medium">Pendiente de envío</p>
                        </div>
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full bg-[#25D366] text-white font-black text-xl py-5 rounded-2xl flex items-center justify-center gap-3 hover:bg-[#20bd5a] transition-all shadow-[0_10px_20px_rgba(37,211,102,0.3)] hover:scale-[1.03] active:scale-95 group"
                    >
                    ...
                    <Link href="/" className="block w-full text-center text-gray-400 font-medium py-2 text-xs hover:underline">
                        Ya envié el mensaje, volver a la tienda
                    </Link>
                </div>
            </div>

    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <AdminStatCard label="En proceso" value={pending + paid} icon={Clock} badge={pending > 0 ? <span className="admin-badge admin-badge-warning">{pending} nuevos</span> : undefined} />

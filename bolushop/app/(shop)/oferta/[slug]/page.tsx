            ...
            <section className="bg-gradient-to-br from-[#11110f] to-[#302f28] text-white py-8 md:py-12 px-4 md:px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    {collection.discountType && collection.discountType !== "none" && collection.discountValue ? (
                        <p className="mt-3 inline-flex rounded-full bg-[#c8f31d] px-4 py-1.5 text-xs font-bold uppercase tracking-wider">
            ...
            <section className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
                {offerProducts.length === 0 ? (
                    <div className="text-center py-16 card">
                        <p className="text-[#6d726a] text-sm md:text-base font-medium">
